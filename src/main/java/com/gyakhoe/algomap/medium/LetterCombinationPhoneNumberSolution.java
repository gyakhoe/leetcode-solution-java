...
public class LetterCombinationPhoneNumberSolution {
    ...
    public List<String> letterCombinationString(String digits) {
    ...
    private void backtrack(String digits, int index, StringBuilder path, Map<Character, String> letterMap,
                           List<String> ans) {
